...
def test_login_functionality(
    env, page, simulator_name: str, test_id: str
) -> tuple[bool, bool]:
    """
...
def run_single_simulator_test(simulator: Dict[str, Any]) -> SimulatorTestMetrics:
    ...
    try:
        ...
        client = SyncPlato(feature_flags={"deployment_color": "green"})
...
def test_all_simulators(simulator_name: Optional[str] = None):
    ...
    try:
        ...
        metrics_file = (
            METRICS_DIR
            / f"{filename_prefix}sync_simulator_autologin_test_{timestamp}.json"
        )
