...
func (x *StartWorkerResponse) Reset() {
	*x = StartWorkerResponse{}
	mi := &file_proto_plato_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StartWorkerResponse) Descriptor() ([]byte, []int) {
	return file_proto_plato_proto_rawDescGZIP(), []int{12}
}
...
var file_proto_plato_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
...
func file_proto_plato_proto_init() {
	...
	file_proto_plato_proto_msgTypes[5].OneofWrappers = []any{}
	file_proto_plato_proto_msgTypes[7].OneofWrappers = []any{}
	file_proto_plato_proto_msgTypes[9].OneofWrappers = []any{}
	file_proto_plato_proto_msgTypes[10].OneofWrappers = []any{}
	file_proto_plato_proto_msgTypes[11].OneofWrappers = []any{}
	type x struct{}
