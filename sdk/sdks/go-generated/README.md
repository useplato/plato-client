...
[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=%2FGo)
...
```go
response, err := client.WithRawResponse.MakeEnvironment(...)
if err != nil {
    return err
}
...
response, err := client.MakeEnvironment(ctx, ...)
```
